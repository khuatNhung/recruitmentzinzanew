...
<head>
  ...
  {{-- datepicker --}}
  <link rel="stylesheet" href="{!!url('public/datepicker/jquery-ui.structure.css')!!}">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="{{ route('cv.index') }}"><i class="fa fa-circle-o"></i>CV</a></li>
            <li><a href="{{ route('recruitment.index') }}"><i class="fa fa-circle-o"></i>Recruitment</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
